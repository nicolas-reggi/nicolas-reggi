...
Mientras tanto, según la recomendación de un Maker genere un segundo hilo, el valor del potenciómetro es leído constantemente y se muestra en la barra de progreso como un porcentaje.
...
<h3><b>Led y potenciometro con Python y MQTT 3</b></h3>
