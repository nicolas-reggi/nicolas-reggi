...
<body>
    <p>Haz clic en el siguiente video para verlo:</p>
    <a href="https://www.youtube.com/watch?v=WfXbkMV8ucY" target="_blank" class="video-link">
        <img src="https://img.youtube.com/vi/WfXbkMV8ucY/0.jpg" alt="Video Thumbnail" width="120">
        Ver video
    </a>
</body>
</html>
...
<head>
    ...
    <style>
        ...
        .video-link img {
            margin-right: 10px;
            width: 320px; /* Puedes ajustar este valor según el tamaño que prefieras */
        }
    </style>
</head>
<body>
    <p>Haz clic en el siguiente video para verlo:</p>
    <a href="https://www.youtube.com/watch?v=TGa0jXX3sWQ" target="_blank" class="video-link">
        <img src="images/mi-video-thumbnail.jpg" alt="Video Thumbnail">
        Ver video
    </a>
</body>
