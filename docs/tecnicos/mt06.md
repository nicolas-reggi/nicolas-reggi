...
<p>Puedes descargar el código del modulo emisor aqui. <a href="https://github.com/nicolas-reggi/nicolas-reggi/blob/main/docs/proyecto/arduino_proyects/sensor_distancia/sensor_distancia.ino" target="_blank">aquí</a>.</p>
