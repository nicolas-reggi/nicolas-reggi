...
Uso de Materiales Reciclados, empleo de PVC flexible, acrílico y aluminio compuesto reciclados, reduciendo el impacto ambiental.


Funcionalidad: 


Aplicación de técnicas no tradicionales en arquitectura y diseño, ofreciendo soluciones adaptativas y dinámicas.


Interactividad:


 Estructuras que responden a estímulos externos, mejorando la experiencia de usuarios y entornos.
